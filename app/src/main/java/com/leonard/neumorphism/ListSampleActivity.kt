...
import com.leonard.neumorphism.databinding.ActivityListSampleBinding
import com.leonard.neumorphism.databinding.ItemCardBinding
...
class ListSampleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityListSampleBinding.inflate(LayoutInflater.from(this))
